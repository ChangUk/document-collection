(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.DocumentCollection = factory());
  ...
  var Collection = function Collection(searchOptions) {
    var _this = this;

    _classCallCheck(this, Collection);

    _defineProperty(this, "_collection", {});
    ...
    _defineProperty(this, "order", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve, reject) {
                resolve(_this._order);
              }));
    ...
    _defineProperty(this, "_findMatches", function (query, docId, doc) {
      for (var _field in doc) {
        if (_field[0] === "_") continue;
        if (!_this._isExcluded(doc[_field]) && _this._searchStrategy(query, doc[_field])) return docId;
      }

      return null;
    });

    _defineProperty(this, "_isExcluded", function (str) {
      if (!_this._searchOptions || !_this._searchOptions.exclude) return false;

      for (var i = 0, len = _this._searchOptions.exclude.length; i < len; i++) {
        var Excluded = _this._searchOptions.exclude[i];
  ...
  var JSONCollection = /*#__PURE__*/function (_Collection) {
    _inherits(JSONCollection, _Collection);

    var _super = _createSuper$1(JSONCollection);
    ...
    function JSONCollection(options) {
      ...
      _this = _super.call(this, options.search);
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  resolve(Object.keys(_this._collection));
                }));
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  if (!(!docId || !(docId in _this._collection))) {
                    _context2.next = 2;
                    break;
                  }
                ...
                case 2:
                  return _context2.abrupt("return", new Promise(function (resolve, reject) {
                    resolve(_this._collection[docId]);
                  }));
      ...
      _defineProperty(_assertThisInitialized(_this), "set", /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(docId, doc) {
              ...
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  return _context3.abrupt("return", new Promise(function (resolve, reject) {
                    _this._collection[docId] = Object.assign(doc, {
                      _id: docId
                    });

                    _this._order.push(docId);
      ...
      _defineProperty(_assertThisInitialized(_this), "update", /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(docId, doc) {
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 2:
                  ...
                  return _context4.abrupt("return", _this.set(docId, Object.assign(doc, {
                    _id: docId
                  })));
                ...
                case 4:
                  ...
                  _context4.t1 = docId;
                  _context4.next = 8;
                  return _this.get(docId).then(function (result) {
                ...
                case 8:
                  ...
                  return _context4.abrupt("return", _context4.t0.set.call(_context4.t0, _context4.t1, _context4.t2));
      ...
      _defineProperty(_assertThisInitialized(_this), "sort", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        var sorter;
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                sorter = function sorter() {
                  var _this$_searchOptions, _this$_searchOptions$;
                  ...
                  var directions = [];
                  var fields = (_this$_searchOptions = _this._searchOptions) === null || _this$_searchOptions === void 0 ? void 0 : (_this$_searchOptions$ = _this$_searchOptions.orderBy) === null || _this$_searchOptions$ === void 0 ? void 0 : _this$_searchOptions$.map(function (field, i) {
                    if (field[0] === "-") {
                      directions[i] = -1;
                  ...
                  return function (a, b) {
                    if (fields) {
                      var docA = _this._collection[a];
                      var docB = _this._collection[b];
                ...
                return _context5.abrupt("return", new Promise(function (resolve, reject) {
                  var results = _this._order.sort(sorter());

                  resolve(results.slice(0, _this._searchOptions.limit || Number.MAX_SAFE_INTEGER - 1));
                }));
      ...
      _defineProperty(_assertThisInitialized(_this), "search", /*#__PURE__*/function () {
        var _ref6 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(query) {
              ...
              switch (_context6.prev = _context6.next) {
                ...
                case 2:
                  return _context6.abrupt("return", new Promise(function (resolve, reject) {
                    var matches = [];
                    if (!_this._searchOptions) return resolve(matches);
                    var total = Object.keys(_this._collection).length;
                    var limit = _this._searchOptions.limit || Number.MAX_SAFE_INTEGER;

                    for (var i = 0; i < total; i++) {
                      var docId = _this._order[i];

                      var match = _this._findMatches(query, docId, _this._collection[docId]);
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt("return", new Promise(function (resolve, reject) {
                  try {
                    for (var docId in _this._collection) {
                      delete _this._collection[docId];
                    }
      ...
      Object.assign(_this._config, options.config || {});
      return _this;
    }
  ...
  */
  ...
  var IDBCollection = /*#__PURE__*/function (_Collection) {
    _inherits(IDBCollection, _Collection);

    var _super = _createSuper(IDBCollection);

    function IDBCollection(options) {
      var _this;

      _classCallCheck(this, IDBCollection);
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  _this._collection.keys().then(function (keys) {
                    resolve(keys);
                  })["catch"](function (err) {
                    resolve([]);
                  });
          ...
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  return _context2.abrupt("return", new Promise(function (resolve, reject) {
                    _this._collection.getItem(docId).then(function (doc) {
                      resolve(doc);
                    })["catch"](function (err) {
                      resolve(null);
                    });
          ...
          return regenerator.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 2:
                  return _context3.abrupt("return", new Promise(function (resolve, reject) {
                    _this._collection.setItem(docId, Object.assign(doc, {
                      _id: docId
                    })).then(function (doc) {
                      _this._order.push(docId);
      ...
      _defineProperty(_assertThisInitialized(_this), "sort", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5() {
        var jsonified, sorter;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return _this.jsonify();

              case 2:
                jsonified = _context5.sent;
                ...
                sorter = function sorter() {
                  ...
                  return function (a, b) {
                    if (fields) {
                      var docA = jsonified[a];
                      var docB = jsonified[b];
              ...
              switch (_context6.prev = _context6.next) {
                ...
                case 2:
                  return _context6.abrupt("return", new Promise(function (resolve, reject) {
                    var matches = [];
                    if (!_this._searchOptions) return resolve(matches);
                    var limit = _this._searchOptions.limit || Number.MAX_VALUE;

                    _this._collection.iterate(function (doc, docId, n) {
                      // `n` is one-based number
                      var match = _this._findMatches(query, docId, doc);
          ...
          return regenerator.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 2:
                  return _context7.abrupt("return", new Promise(function (resolve, reject) {
                    localForage.removeItem(docId).then(function () {
                      resolve(true);
                    })["catch"](function (err) {
                      resolve(false);
                    });
      ...
      _defineProperty(_assertThisInitialized(_this), "jsonify", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
        var units, jsonified;
        return regenerator.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                _context10.next = 2;
                return Promise.all(_this._order.map( /*#__PURE__*/function () {
                  var _ref10 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(docId) {
                    var unit, doc;
                      ...
                      while (1) {
                        switch (_context9.prev = _context9.next) {
                          ...
                          case 3:
                            ...
                            return _context9.abrupt("return", Promise.resolve(unit));
              ...
              case 2:
                ...
                return _context10.abrupt("return", jsonified);
      ...
      try {
        _this._collection = localForage.createInstance({
          ...
          storeName: _this._config.collectionName
        });
      } catch (err) {
  ...
  var DocumentCollection = function DocumentCollection(options) {
    ...
    _defineProperty(this, "_options", {
      type: "indexeddb",
      // "json" | "indexeddb" | "firestore"
      config: {},
      search: {}
    });

    _defineProperty(this, "getRandomId", function () {
      return new ShortUuidV4()["new"]();
    });

    _defineProperty(this, "getDocument", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(docId) {
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    _defineProperty(this, "getAllDocuments", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
    ...
    _defineProperty(this, "getDocumentsOrder", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
      return regenerator.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
            ...
            case 2:
              _context3.next = 4;
              return _this._collection.order();
    ...
    _defineProperty(this, "setDocument", /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(docId, doc) {
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                _context4.next = 7;
                return _this._collection.set(docId, JSON.parse(doc));
              ...
              case 10:
                ...
                _context4.next = 13;
                return _this._collection.set(docId, doc);
    ...
    _defineProperty(this, "search", /*#__PURE__*/function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(query) {
        var isValidQuery;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                isValidQuery = function isValidQuery(query) {
              ...
              case 3:
                ...
                _context5.next = 6;
                return _this._collection.search(query);
    ...
    _defineProperty(this, "removeDocument", /*#__PURE__*/function () {
    ...
    _defineProperty(this, "clear", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
      return regenerator.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
    ...
    _defineProperty(this, "_isJSON", function (json) {
      try {
    ...
    var StorageType = this._options.type.toLowerCase();
    ...
    if (StorageType === "json") {
      ...
      throw new Error("Invalid storage type: ".concat(this._options.type));
    }
  };
